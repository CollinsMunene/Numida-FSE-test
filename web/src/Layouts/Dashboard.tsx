...
const user = {
  ...
  imageUrl:
    "https://collinsmunene.github.io/collinshillary.github.io/assets/img/Collins.jpg",
};

// Can be converted to menu items later
const navigation = [
  { name: "Collins Munene Numida Test", href: "#", current: true }
];
